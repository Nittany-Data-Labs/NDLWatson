...
def classifyJournal(filename, classifier_id):
    ...
    with open(str(filename)+'_classed.csv', 'w') as csvfile:
        fieldnames = ['Sentence', 'Class', 'Confidence']
        ...
        for i in journal:
            ...
            try:
                ...
                writer.writerow({'Sentence': i, 'Class': classed[0], 'Confidence': classed[1]})
            except:
                print 'error'
    journal.close()
...
classifyJournal('Journals/CaliforniaDream/goodnight277', classifier_id)
